  ...
  return (
    <div className="min-h-screen w-full bg-slate-900">
      <div className="min-h-screen bg-slate-900 py-8">
        <main className="relative max-w-4xl mx-auto px-4 py-10 sm:px-6 lg:px-8 bg-slate-800 rounded-lg shadow-lg border border-slate-700">
          {/* Close Button */}
          <button
            onClick={handleClose}
            ...
            aria-label="Close"
          >
            <X className="h-5 w-5 sm:h-6 sm:w-6 text-slate-300" />
          </button>
          ...
          {/* Entity Info */}
          <div className="bg-slate-700 p-4 rounded-md shadow-sm border border-slate-600 mb-6 text-slate-200">
            <p>
          ...
          <div className="space-y-6 text-slate-200 leading-relaxed">
            <Section title="1. Information We Collect">
              <ul className="list-disc list-inside space-y-2">
                <li>
                  ...
                  address, payment details, and account credentials.
                </li>
                <li>
                  <strong>Non-Personal Information:</strong> Device type,
                  browser, IP address, and usage data.
                </li>
                <li>
                  <strong>Order Data:</strong> Items ordered, order history, and
                  payment method.
                </li>
              </ul>
            </Section>
            ...
            <Section title="2. How We Use Your Information">
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  Send order updates, promotional offers, and notifications.
                </li>
            ...
            <Section title="4. Data Security">
              ...
              protect your data in compliance with Indian IT laws.
            </Section>
            ...
            <Section title="9. Children's Privacy">
              Our Platform is intended for users aged 18+. If under 18, you may
              use the Platform only under parental/guardian supervision.
            </Section>

            <Section title="10. Changes to this Policy">
              We may update this Privacy Policy from time to time. Changes are
              effective upon posting. Continued use implies acceptance.
            </Section>
