...
import { GetOrderDetails, UpdateOrderStatus } from '../../../../services/operations/Orders';
...
const OrderDetailsDialog = () => {
  ...
  const handleStatusUpdate = async (newStatus) => {
    ...
    try {
      const response = await UpdateOrderStatus(orderDetails._id, { status: newStatus }, token);
  ...
  return (
    <Dialog open={!!orderDetails} onOpenChange={handleClose}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="min-w-0">
              ...
              <DialogDescription className="text-gray-600 mt-1 text-sm sm:text-base">
                Order #{orderDetails.OrderNumber || orderDetails._id.slice(-8).toUpperCase()}
              </DialogDescription>
            </div>
            <Badge
              className={`${getStatusColor(orderDetails.status)} border px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm font-medium self-start sm:self-auto`}
            >
        ...
        <div className="space-y-4 sm:space-y-6 pt-4 sm:pt-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4">
            ...
            <div className="bg-white border border-gray-200 p-3 sm:p-5 rounded-lg shadow-sm">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Order Number</span>
                  <span className="font-semibold text-gray-600 mt-1 text-sm break-all">
                    {orderDetails.OrderNumber || 'N/A'}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Total Amount</span>
                  <span className="font-bold text-base sm:text-lg text-gray-600 mt-1">
                    ₹{orderDetails.total?.toFixed(2)}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Order Date</span>
                  <span className="text-gray-600 mt-1 text-sm">
                    {new Date(orderDetails.createdAt).toLocaleDateString()}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Order Time</span>
                  <span className="text-gray-600 mt-1 text-sm">
                ...
                {orderDetails.pickupTime && (
                  <div className="flex flex-col">
                    <span className="text-gray-500 text-xs font-medium uppercase">Pickup Time</span>
                    <span className="text-gray-600 mt-1 text-sm">
                ...
                {orderDetails.groupOrderId && (
                  <div className="flex flex-col">
                    <span className="text-gray-500 text-xs font-medium uppercase">Group Order</span>
            ...
            <div className="bg-white border border-gray-200 p-3 sm:p-5 rounded-lg shadow-sm">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Student Name</span>
                ...
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Student ID</span>
                ...
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Canteen</span>
                  <span className="font-semibold text-gray-600 mt-1 text-sm break-words">
                    {orderDetails.canteen?.name || 'N/A'}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Canteen ID</span>
                  <span className="text-gray-600 font-mono text-xs sm:text-sm mt-1 break-all">
                ...
                {orderDetails.student?.phone && (
                  <div className="flex flex-col">
                    <span className="text-gray-500 text-xs font-medium uppercase">Phone</span>
            ...
            <div className="bg-white border border-gray-200 p-3 sm:p-5 rounded-lg shadow-sm">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Created</span>
                  <span className="text-gray-600 text-xs sm:text-sm mt-1">
                    {new Date(orderDetails.createdAt).toLocaleString()}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-gray-500 text-xs font-medium uppercase">Last Updated</span>
                  <span className="text-gray-600 text-xs sm:text-sm mt-1">
                ...
                {orderDetails.estimatedTime && (
                  <div className="flex flex-col">
                    <span className="text-gray-500 text-xs font-medium uppercase">Estimated Time</span>
                    <span className="text-gray-600 text-xs sm:text-sm mt-1">
                ...
                {orderDetails.specialInstructions && (
                  <div className="flex flex-col">
                    <span className="text-gray-500 text-xs font-medium uppercase">Special Instructions</span>
          ...
          <div className="bg-white border border-gray-200 p-3 sm:p-5 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              <div className="flex flex-col">
                <span className="text-gray-500 text-xs font-medium uppercase">Payment Method</span>
              ...
              <div className="flex flex-col">
                <span className="text-gray-500 text-xs font-medium uppercase">Payment Status</span>
                <Badge
              ...
              <div className="flex flex-col">
                <span className="text-gray-500 text-xs font-medium uppercase">Tax & Fees</span>
                <span className="font-semibold text-gray-600 mt-1 text-sm">
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-gray-600 mt-1 flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 text-xs sm:text-sm">
                      ...
                      {item.category && <span className="text-gray-500">Category: {item.category}</span>}
                    </div>
                    {item.description && (
                  ...
                  <div className="text-left sm:text-right flex-shrink-0">
                    <div className="font-semibold text-base sm:text-lg text-gray-900">
                      ₹{((item.quantity || 0) * (item.priceAtPurchase || item.price || 0)).toFixed(2)}
                    </div>
                  </div>
                </div>
              ))}
