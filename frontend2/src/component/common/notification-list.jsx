...
import { fetchUserNotifications } from "../lib/api"; // ✅ adjust path for your project
import { Bell, Clock } from "lucide-react";

const NotificationList = ({ userId, isOpen, onClose }) => {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // filter / map only required data
        const filtered = res.map((n) => ({
          _id: n._id,
          message: n.message,
