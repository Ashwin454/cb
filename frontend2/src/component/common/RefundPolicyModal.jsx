...
export const RefundPolicyModal = ({ onOpenChange, onOpen }) => {
  return (
    <div
    ...
    >
      ...
      {/* Modal Content */}
      <div className="relative bg-white dark:bg-gray-900 rounded-lg shadow-xl w-full max-w-4xl h-[90vh] sm:h-[85vh] md:h-[80vh] lg:h-[75vh] mx-2 sm:mx-4 overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white pr-2">
            Refund Policy - Campus Bites
          </h2>
          <button
            onClick={() => onOpenChange(false)}
        ...
        {/* Scrollable Content */}
        <div className="overflow-y-auto h-full bg-white dark:bg-gray-900 transition-colors duration-300">
          {/* Header */}
          ...
          <main className="px-4 sm:px-6 py-8 sm:py-12">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
              {/* Title Section */}
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-800 px-4 sm:px-8 py-6 sm:py-10 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="mb-8 sm:mb-10">
                  <div className="relative p-4 sm:p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border-l-4 border-blue-500 shadow-sm">
                    ...
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          <div className="flex items-start space-x-3 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          ...
                          <div className="flex items-start space-x-3 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                            ...
                            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                              ...
                              <span className="font-bold text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/30 px-1 sm:px-2 py-1 rounded text-xs sm:text-sm">
                                5–7 business days
                              </span>
                  ...
                  <section className="group">
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="relative p-4 sm:p-6 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl border-l-4 border-yellow-500 shadow-sm">
                          <div className="absolute top-4 right-4">
                            <svg
                  ...
                  <section className="group">
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="relative p-4 sm:p-6 bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 rounded-xl border-l-4 border-red-500 shadow-sm">
                          <div className="absolute top-4 right-4">
                            <svg
                          ...
                          <p className="text-sm sm:text-base text-gray-800 dark:text-gray-200 font-semibold mb-3 sm:mb-4">
                ...
                <div className="mt-12 sm:mt-16">
                  <div className="relative overflow-hidden p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl border border-gray-200 dark:border-gray-600 shadow-lg">
